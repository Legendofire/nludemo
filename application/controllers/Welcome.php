...
class Welcome extends CI_Controller {
    ...
    public function getKeyWords($text, $isUrl) {
        ...
        if ($isUrl) {
            ...
            $response = file_get_contents('https://6fa349f6-dec8-4bd7-a9ab-ab3a579e3999:NZP76VFjCvbd@gateway.watsonplatform.net/natural-language-understanding/api/v1/analyze?version=2017-02-27&text=' . urlencode($text) . '&features=Concepts', false, stream_context_create($arrContextOptions));
        }
